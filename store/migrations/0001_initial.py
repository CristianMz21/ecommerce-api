    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["name", "is_active"], name="store_categ_name_d71082_idx"
                    )
                ],
            },
        ),
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="store_order_created_d97ec5_idx",
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["name", "category"], name="store_produ_name_72b6df_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["price", "is_active"], name="store_produ_price_d9f31d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="orderitem",
            index=models.Index(
                fields=["order", "product"], name="store_order_order_i_04434a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="orderitem",
            index=models.Index(
                fields=["product", "order"], name="store_order_product_b5e61c_idx"
            ),
        ),
    ]
